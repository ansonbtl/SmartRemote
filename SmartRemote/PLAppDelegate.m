...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    PLViewController *controller = [[PLViewController alloc] init];
...
- (void)launchSetup {
    PLSetupController *controller = [[PLSetupController alloc] initWithNibName:@"PLSetupController" bundle:nil];
